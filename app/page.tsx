    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-50 font-sans selection:bg-indigo-500/30">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-zinc-800/50 bg-zinc-950/80 backdrop-blur-md">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-3 sm:px-6 lg:px-8 gap-2">
          <Link href="/" className="flex items-center gap-2 min-w-0 flex-shrink-0 group">
            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-indigo-500/20 border border-indigo-500/30">
              <Terminal className="h-4 w-4 sm:h-5 sm:w-5 text-indigo-400 group-hover:text-indigo-300 transition-colors" />
            </div>
            <span className="text-lg sm:text-xl font-bold tracking-tight text-zinc-100">Resumate</span>
          </Link>
          ...
          <div className="flex items-center gap-1.5 sm:gap-3 flex-shrink-0">
            <a
              ...
              className="flex h-8 w-8 sm:h-auto sm:w-auto items-center justify-center sm:gap-2 rounded-full border border-zinc-800 bg-zinc-900/80 sm:px-3.5 sm:py-2 text-sm font-medium text-zinc-300 hover:bg-zinc-800 hover:text-white transition-all"
            ...
            <Link
              href="/builder"
              className="flex items-center justify-center rounded-full bg-indigo-500 hover:bg-indigo-400 px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-semibold text-white shadow-sm hover:shadow-indigo-500/25 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 transition-all whitespace-nowrap hover:scale-105 active:scale-95"
            >
              Get Started
            </Link>
          </div>
